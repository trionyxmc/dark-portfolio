...
const shared = [
  ...
  { id: 7, num: '?', name: '', ph: '?', images: ['tu-imagen-1.jpg'] },
  { id: 8, num: '?', name: '', ph: '?', images: ['tu-imagen-1.jpg'] },
  { id: 9, num: '?', name: '', ph: '?', images: ['tu-imagen-1.jpg'] },
]
...
const projectsCopy = {
  en: [
    ...
    { name: 'Coming Soon', type: 'Next Project', result: 'Reserved slot', technologies: [] as string[],
      description: 'This slot is reserved for an upcoming project. Check back soon for the full details.' },
    { name: 'Coming Soon', type: 'Next Project', result: 'Reserved slot', technologies: [] as string[],
      description: 'This slot is reserved for an upcoming project. Check back soon for the full details.' },
    { name: 'Coming Soon', type: 'Next Project', result: 'Reserved slot', technologies: [] as string[],
      description: 'This slot is reserved for an upcoming project. Check back soon for the full details.' },
  ...
  es: [
    ...
    { name: 'Próximamente', type: 'Próximo Proyecto', result: 'Espacio reservado', technologies: [] as string[],
      description: 'Este espacio esta reservado para un proximo proyecto. Vuelve pronto para ver los detalles completos.' },
    { name: 'Próximamente', type: 'Próximo Proyecto', result: 'Espacio reservado', technologies: [] as string[],
      description: 'Este espacio esta reservado para un proximo proyecto. Vuelve pronto para ver los detalles completos.' },
    { name: 'Próximamente', type: 'Próximo Proyecto', result: 'Espacio reservado', technologies: [] as string[],
      description: 'Este espacio esta reservado para un proximo proyecto. Vuelve pronto para ver los detalles completos.' },

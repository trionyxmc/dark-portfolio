...
const servicesData = {
  en: [
    ...
    { title: '🏢 Dedicated Server Setup', description: 'I install and configure your dedicated server, ready for production, no surprises later.',
  ...
  es: [
    ...
    { title: '🏢 Instalacion de Dedicados', description: 'Instalo y configuro tu servidor dedicado listo para produccion, sin sustos despues.',
